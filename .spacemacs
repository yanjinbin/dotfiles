...
(defun dotspacemacs/layers ()
 ...
 ;; 安装你的package最佳实践方式因为 package-install会在下次启动时删除掉
...
(custom-set-variables
 ...
 '(custom-safe-themes
   (quote
    ("b89ae2d35d2e18e4286c8be8aaecb41022c1a306070f64a66fd114310ade88aa" "e1d09f1b2afc2fed6feb1d672be5ec6ae61f84e058cb757689edb669be926896" "a06658a45f043cd95549d6845454ad1c1d6e24a99271676ae56157619952394a" "123a8dabd1a0eff6e0c48a03dc6fb2c5e03ebc7062ba531543dfbce587e86f2a" "c1fb68aa00235766461c7e31ecfc759aa2dd905899ae6d95097061faeb72f9ee" "890a1a44aff08a726439b03c69ff210fe929f0eff846ccb85f78ee0e27c7b2ea" "57e3f215bef8784157991c4957965aa31bac935aca011b29d7d8e113a652b693" "a390bea70629258d80f41a42098bafcc636cd5f29f2449f00a86c1dabf68358d" "60317874283814fe51bda023c1fc26dc983db0853796d5cd6dfd09d7331fc77a" "d4131a682c4436bb5a61103d9a850bf788cbf793f3fd8897de520d20583aeb58" "801a567c87755fe65d0484cb2bded31a4c5bb24fd1fe0ed11e6c02254017acb2" "bffa9739ce0752a37d9b1eee78fc00ba159748f50dc328af4be661484848e476" "fa2b58bb98b62c3b8cf3b6f02f058ef7827a8e497125de0254f56e373abee088" default)))
 '(evil-want-Y-yank-to-eol nil)
 '(global-hl-line-sticky-flag nil)
 '(package-selected-packages
   (quote
    (evil-magit git-commit with-editor transient diff-hl highlight quickrun magit flyspell-correct-helm flyspell-correct auto-dictionary unfill mwim helm-company helm-c-yasnippet fuzzy company-statistics auto-yasnippet ac-ispell auto-complete clang-format+ disaster cmake-mode clang-format indy smart-compile cmake-ide helm-rtags flycheck-rtags company-rtags rtags flycheck-indent company-irony-c-headers company-irony flycheck-irony flycheck-cstyle flycheck-clangcheck flycheck-golangci-lint flycheck-clang-analyzer company-c-headers company-ctags company-go company yasnippet gruvbox-theme nerdtab hemisu-theme leuven-theme afternoon-theme white-sand-theme whitespace-cleanup-mode white-theme tao-theme smeargle orgit mmm-mode markdown-toc markdown-mode magit-gitflow magit-popup helm-gitignore gitignore-mode gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-gutter-fringe+ git-gutter-fringe fringe-helper git-gutter+ git-gutter gh-md flycheck-pos-tip pos-tip flycheck ws-butler winum which-key volatile-highlights vi-tilde-fringe uuidgen use-package toc-org spaceline powerline restart-emacs request rainbow-delimiters popwin persp-mode pcre2el paradox spinner org-plus-contrib org-bullets open-junk-file neotree move-text macrostep lorem-ipsum linum-relative link-hint indent-guide hydra lv hungry-delete hl-todo highlight-parentheses highlight-numbers parent-mode highlight-indentation helm-themes helm-swoop helm-projectile projectile pkg-info epl helm-mode-manager helm-make helm-flx helm-descbinds helm-ag google-translate golden-ratio flx-ido flx fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired f evil-tutor evil-surround evil-search-highlight-persist evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-lisp-state smartparens evil-indent-plus evil-iedit-state iedit evil-exchange evil-escape evil-ediff evil-args evil-anzu anzu evil goto-chg undo-tree eval-sexp-fu elisp-slime-nav dumb-jump dash s diminish define-word column-enforce-mode clean-aindent-mode bind-map bind-key auto-highlight-symbol auto-compile packed aggressive-indent adaptive-wrap ace-window ace-link ace-jump-helm-line helm avy helm-core popup async))))
...
;;  auto format on save with clang-format

;;  ===clang-format auto-create then auto-format on save ==== start====
;; 做法来源于此博客 https://bit.ly/2BUpIDa
 ;; 自动创建clang-format 文件
...
;;  ===clang-format auto-create then auto-format on save ==== end====
    ...
    (if (not (null (find t candidate-make-file-name :key
      ...
      (let* ((filename (file-name-nondirectory buffer-file-name))
        ...
        (cond ((eq major-mode 'c-mode)
               ...
               (setq command (concat command " -o ./build" executable " " filename)))
              ((eq major-mode 'c++-mode)
               ;; add libs for header
               (setq command "g++ -Wall -O2 -std=c++14")
               (save-excursion
                 (goto-char (point-min))
                 (when (re-search-forward "^#include <pthread.h>" nil t)
                   (setq command (concat command " -lpthread")))
                ...
                ;;  (setq command (concat command "-std=c++14")))
                ;; (goto-char (point-min))
...
(defun smart-run ()
  ...
  (let* ((filename (file-name-nondirectory buffer-file-name))
    ...
    (cond ((or (eq major-mode 'c-mode) (eq major-mode 'c++-mode))
           (setq command (concat "./build/" executable)))
...
;; 窗口切换
(global-set-key [f3] 'scroll-other-window)
...
;; 新窗口打开新的文件
(global-set-key [f7] 'find-file-other-window)
...
;; (define-key c-mode-base-map [f11] 'smart-compile)
;; (define-key c-mode-base-map [f12] 'smart-run)
(define-key c-mode-base-map (kbd "C-c C-r") 'smart-run)


;; 全局绑定
(global-set-key [f11] 'smart-compile)
(global-set-key [f12] 'smart-run)
